...
#define SERVER_ADDRESS "https://testesp32.maurodas.repl.co/local"
...
void sendHttpRequest() {
  ...
  String message = "Estoy cansado, jefe";

  http.addHeader("Content-Type", "application/x-www-form-urlencoded");
  int res = http.POST("message=" + message);
...
class MyServerCallbacks: public BLEServerCallbacks {
    void onConnect(BLEServer* pServer) {
      ...
      // sendHttpRequest(); // Send the HTTP request when a client connects
    };
